...
This repository contains the following branches:
  ...
  - **`main`** &ndash; Development of the upcoming minor release.
...
Note that the `main` branch is under heavy development. Its code did not pass the release testing phase, though, so it may be unstable.
